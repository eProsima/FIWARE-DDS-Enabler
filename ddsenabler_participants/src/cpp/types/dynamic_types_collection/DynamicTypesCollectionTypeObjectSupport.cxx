...
#include <ddsenabler_participants/types/dynamic_types_collection/DynamicTypesCollectionTypeObjectSupport.hpp>
        ...
        TypeIdentifierPair& type_ids_DynamicType)
{
    ...
    return_code_DynamicType =
        ...
        "eprosima::ddsenabler::participants::DynamicType", type_ids_DynamicType);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_DynamicType)
    {
        StructTypeFlag struct_flags_DynamicType = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_DynamicType = "eprosima::ddsenabler::participants::DynamicType";
        ...
        {
            TypeIdentifierPair type_ids_type_identifier;
            ReturnCode_t return_code_type_identifier {eprosima::fastdds::dds::RETCODE_OK};
            return_code_type_identifier =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "anonymous_string_unbounded", type_ids_type_identifier);
            ...
            StructMemberFlag member_flags_type_identifier = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_type_identifier = 0x00000001;
            bool common_type_identifier_ec {false};
            CommonStructMember common_type_identifier {TypeObjectUtils::build_common_struct_member(member_id_type_identifier, member_flags_type_identifier, TypeObjectUtils::retrieve_complete_type_identifier(type_ids_type_identifier, common_type_identifier_ec))};
            if (!common_type_identifier_ec)
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION, "Structure type_identifier member TypeIdentifier inconsistent.");
                return;
            }
            MemberName name_type_identifier = "type_identifier";
            eprosima::fastcdr::optional<AppliedBuiltinMemberAnnotations> member_ann_builtin_type_identifier;
            ann_custom_DynamicType.reset();
            CompleteMemberDetail detail_type_identifier = TypeObjectUtils::build_complete_member_detail(name_type_identifier, member_ann_builtin_type_identifier, ann_custom_DynamicType);
            CompleteStructMember member_type_identifier = TypeObjectUtils::build_complete_struct_member(common_type_identifier, detail_type_identifier);
            TypeObjectUtils::add_complete_struct_member(member_seq_DynamicType, member_type_identifier);
        }
        {
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "eprosima::ddsenabler::participants::DynamicType already registered in TypeObjectRegistry for a different type.");
        }
    }
}
// TypeIdentifier is returned by reference: dependent structures/unions are registered in this same method
        ...
        TypeIdentifierPair& type_ids_DynamicTypesCollection)
{
    ...
    return_code_DynamicTypesCollection =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "eprosima::ddsenabler::participants::DynamicTypesCollection", type_ids_DynamicTypesCollection);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_DynamicTypesCollection)
    {
        StructTypeFlag struct_flags_DynamicTypesCollection = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_DynamicTypesCollection = "eprosima::ddsenabler::participants::DynamicTypesCollection";
        ...
        CompleteStructMemberSeq member_seq_DynamicTypesCollection;
        {
            ...
            return_code_dynamic_types =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded", type_ids_dynamic_types);

            if (eprosima::fastdds::dds::RETCODE_OK != return_code_dynamic_types)
            {
                return_code_dynamic_types =
                    eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                    "eprosima::ddsenabler::participants::DynamicType", type_ids_dynamic_types);

                if (eprosima::fastdds::dds::RETCODE_OK != return_code_dynamic_types)
                {
                    eprosima::ddsenabler::participants::register_DynamicType_type_identifier(type_ids_dynamic_types);
                }
                bool element_identifier_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded_ec {false};
                TypeIdentifier* element_identifier_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded {new TypeIdentifier(TypeObjectUtils::retrieve_complete_type_identifier(type_ids_dynamic_types, element_identifier_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded_ec))};
                if (!element_identifier_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded_ec)
                {
                    EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION, "Sequence element TypeIdentifier inconsistent.");
                    return;
                }
                EquivalenceKind equiv_kind_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded = EK_COMPLETE;
                if (TK_NONE == type_ids_dynamic_types.type_identifier2()._d())
                {
                    equiv_kind_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded = EK_BOTH;
                }
                CollectionElementFlag element_flags_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded = 0;
                PlainCollectionHeader header_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded = TypeObjectUtils::build_plain_collection_header(equiv_kind_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded, element_flags_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded);
                {
                    SBound bound = 0;
                    PlainSequenceSElemDefn seq_sdefn = TypeObjectUtils::build_plain_sequence_s_elem_defn(header_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded, bound,
                                eprosima::fastcdr::external<TypeIdentifier>(element_identifier_anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded));
                    if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                            TypeObjectUtils::build_and_register_s_sequence_type_identifier(seq_sdefn, "anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded", type_ids_dynamic_types))
                    {
                        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                            "anonymous_sequence_eprosima_ddsenabler_participants_DynamicType_unbounded already registered in TypeObjectRegistry for a different type.");
                    }
                }
            }
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "eprosima::ddsenabler::participants::DynamicTypesCollection already registered in TypeObjectRegistry for a different type.");
        }
    }
}
