...
/*
   Expected defines.
   - EPROSIMA_DDSENABLER_YAML_LIB_NAME
   - DDSENABLER_YAML_VERSION_MAJOR
   - DDSENABLER_YAML_VERSION_MINOR
 */
...
// Include library
    #if defined(EPROSIMA_DDSENABLER_YAML_LIB_NAME) \
    && defined(EPROSIMA_LIB_PREFIX) \
    && defined(EPROSIMA_LIB_DEBUG_TAG) \
    && defined(DDSENABLER_YAML_VERSION_MAJOR) \
    && defined(DDSENABLER_YAML_VERSION_MINOR)
        #pragma \
    comment(lib, EPROSIMA_LIB_PREFIX EPROSIMA_STRINGIZE(EPROSIMA_DDSENABLER_YAML_LIB_NAME) EPROSIMA_LIB_DEBUG_TAG "-" EPROSIMA_STRINGIZE(DDSENABLER_YAML_VERSION_MAJOR) "." EPROSIMA_STRINGIZE(DDSENABLER_YAML_VERSION_MINOR) ".lib")
    #else
    #error "Some required macros where not defined"
    #endif // if defined(EPROSIMA_DDSENABLER_YAML_LIB_NAME) && defined(EPROSIMA_LIB_PREFIX) && defined(EPROSIMA_LIB_DEBUG_TAG) && defined(DDSENABLER_YAML_VERSION_MAJOR) && defined(DDSENABLER_YAML_VERSION_MINOR)
...
#ifdef EPROSIMA_DDSENABLER_YAML_LIB_NAME
#undef EPROSIMA_DDSENABLER_YAML_LIB_NAME
#endif // ifdef EPROSIMA_DDSENABLER_YAML_LIB_NAME
